...
import { Plus, FileText, Clock, CheckCircle, TrendingUp, Zap, BookOpen } from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ onNewDocument, onBusinessTemplate, onCoursePlanTemplate }) => {
