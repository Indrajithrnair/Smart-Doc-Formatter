...
class ProcessingRequest(BaseModel):
    user_goal: str
    formatting_mode: Optional[str] = "contextual"  # "contextual" or "template"
    template_type: Optional[str] = "business_proposal"  # Type of template to use
...
class JobStatus(BaseModel):
    ...
    final_result_data: Optional['FinalProcessingResultData'] = None
